#!/usr/bin/env node
/**
 * fetch-mars-photos.mjs — Últimas fotos dos rovers da NASA em Marte
 *
 * Requer: Node 18+ e NASA_API_KEY (grátis em https://api.nasa.gov)
 * Uso: NASA_API_KEY=xxxxx node scripts/fetch-mars-photos.mjs
 */
...
async function latestPhoto(rover) {
  ...
  // Prefer photos from Mastcam/NAVCAM (better composed)
